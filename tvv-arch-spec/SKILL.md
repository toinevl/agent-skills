...
scope: [all]
triggers: [write spec, technical spec, feature spec, spec for]
status: stable
created: '2026-07-23'
last_updated: '2026-07-29'
---

# tvv-arch-spec: Technical Feature Specification
...
### API contract
New or modified endpoints — use tvv-arch-api-design format for each.
