---
name: tvv-infra-script-authoring
...
category: ops
scope: [all]
triggers: [writing bash script, proxmox script, infra script, shell automation]
status: stable
created: '2026-07-23'
...
| Proxmox CLI values and enum traps | tvv-infra-script-authoring + Proxmox checklist |
